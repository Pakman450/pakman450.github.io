  ...
  return (
    <>
        <div className=' w-full grid justify-center max-w-7xl rounded-lg my-2 py-20 px-10 text-white bg-[#19376D] drop-shadow-2xl'>
            ...
            <div className=" snap-x flex snap-mandatory bg-white space-x-10 rounded-lg py-10 md:py-40 px-10 w-full max-w-4xl overflow-y-hidden">

              <div className="snap-center bg-black  grid min-w-[90%] h-80 place-items-center text-8xl border-black rounded-2xl drop-shadow-2xl">
                1asdfasdfsdf
              </div>
